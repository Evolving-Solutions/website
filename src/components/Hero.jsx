...
export function Hero() {
  ...
  return (
    <>
      {modal ? (
        <Contactform open={modal}  onClose={setModal} />
      ) : (
        <Container className="pt-20 pb-16 text-center lg:pt-32">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700">
            {/* let them know we are coming soon and looking for beta testers */}
            We are currently in private beta. If you are interested in joining,
